...
> *Adicione aqui prints das principais telas (login, dashboard, chat de IA, geração de peças, monitoramento).*

<!-- Exemplo de como inserir imagens depois de fazer upload:
![Dashboard](docs/dashboard.png)
![Chat de IA](docs/chat-ia.png)
-->
